...
import static com.jgcomptech.adoptopenjdk.util.Utils.convertBytesToString;

public class FileProgressBarRenderer implements ProgressBarRenderer {
    ...
    private String ratio(final ProgressState progress) {
        final String m = progress.indefinite ? "?" : convertBytesToString(progress.max / unitSize);
        final String c = convertBytesToString(progress.current / unitSize);
